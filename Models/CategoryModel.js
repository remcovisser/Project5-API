...
module.exports = {
    index: function(res)
    {
        baseModel.get(res, 'SELECT * from Category');
    },

    show: function(res, id)
    {
        baseModel.get(res, 'SELECT * from Category WHERE category_id = ' + id);
    },
    ...
    {
        baseModel.send(res, 'DELETE FROM Category WHERE category_id = ' + id);
    }
};