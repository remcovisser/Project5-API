...
module.exports = {
    registeredUsers: function(res)
    {
        ...
        baseModel.getData(res, "SELECT COUNT(DISTINCT y.user_id) as users, DAY(x.create_date) as day FROM User x JOIN User y ON y.create_date <= x.create_date GROUP BY day", callback);
    },
